...
class GoldForDiamondsEditForms extends Component {
    constructor(props){
        console.log(props)
        super(props)
        this.state = {
        ...
        return (
            <Modal destroyOnClose={true} maskClosable={false} visible={this.props.isPop} title={this.props.title} okText="保存" cancelText="关闭" onCancel={this.props.editPopClose} onOk={this.props.editPopOk}>
                <Form layout="horizontal">
                    ...
                    <FormItem {...formItemLayout} label="钻石数对应金币数">
                        {getFieldDecorator('goldForDiamonds', {
                            rules: [{ required: true, message: '请输入钻石数对应金币数!' }],
                        })(
                            <Input />
                        )}
                    </FormItem>
...
const GoldForDiamondsEditForm = Form.create()(GoldForDiamondsEditForms);
export default GoldForDiamondsEditForm;