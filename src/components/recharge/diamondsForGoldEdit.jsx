...
class DiamondsForGoldEditForms extends Component {
    constructor(props){
        console.log(props)
        super(props)
        this.state = {
...
const DiamondsForGoldEditForm = Form.create()(DiamondsForGoldEditForms);
export default DiamondsForGoldEditForm;