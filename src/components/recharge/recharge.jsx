...
import RechargeEditForm from './rechargeEdit';
...
class Recharge extends Component {
    constructor(props){
        ...
        this.columns = [{
            ...
            title: '钻石数对应金额',
            width:'150px',
            dataIndex: 'numForMoneyList',
        }, {
            title: '返金币数',
            width:'150px',
            dataIndex: 'returnNumList',
        }, {
            title: '列表排序',
            width:'150px',
            dataIndex: 'sortList',
    ...
    render() {
        return (
            <div className="gutter-example" style={{ background:'#fff'}}>
                <BreadcrumbCustom first="货币配置" second="充值管理" />
                ...
                <RechargeEditForm isType={this.state.addOrEditType} title={this.state.addOrEditPopTitle} isPop={this.state.addOrEditPopVisible} editPopOk={this.handleAddAndEditOk.bind(this)} editPopClose={this.handleCancel.bind(this)} />
